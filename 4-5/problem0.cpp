...
int main() {
    ...
    std::cout << "apple vs apple: "
              << String::is_identical(apples[5], apples[6]) << std::endl;
    apples[6].erase(1, 2);
    apples[6].describe();
    ...
    std::cout << "find p from apple from 0: "
              << apples[7].find(0, 'p') << std::endl;
    std::cout << "find p from apple from 2: "
              << apples[7].find(2, 'p') << std::endl;
